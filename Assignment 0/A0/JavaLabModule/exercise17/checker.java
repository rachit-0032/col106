public class checker
{
	...
	{
		String inputs[][] = {{}, {"a.java","a.pdf"}, {"a.java","a.java.pdf","b.java"}, {"a","java.txt", "cp.java", "a.rm", "co.dejava"}, {"txt.j ava", "decode.java", "a.java.bin", "a.java.pdf.java"}};
		String outputs[][] = {{}, {"a.java"}, {"a.java", "b.java"}, {"cp.java"}, {"decode.java", "a.java.pdf.java"}};
