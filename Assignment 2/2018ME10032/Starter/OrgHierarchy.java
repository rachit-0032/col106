...
/* 
	...
	n is the number of employees, we need to have a heightDiffd tree. Thus, AVL trees work for this implementation.
	...
	*/
	...
	public void hireEmployee(int id, int bossid) throws IllegalIDException, EmptyTreeException{
		...
		if(isEmpty())
			...
			AVLNode temp = searchAVLNode(AVLRoot, bossid); //Sarch for the node
