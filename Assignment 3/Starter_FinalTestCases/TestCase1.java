...
public class TestCase1 {
    public static void main(String[] args){
        ...
        try{
            // Customer 1 arrives
            System.out.println(mm.customerState(1, 0));
            mm.arriveCustomer(1, 0, 3);
            System.out.println(mm.customerState(1, 1));
            // Customer 2 arrives
        ...
        try{
            ...
            System.out.println(mm.customerState(1, 11));
            System.out.println(mm.customerState(1, 12));
            System.out.println(mm.customerState(1, 12));
            System.out.println(mm.isEmpty());
